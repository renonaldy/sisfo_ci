<div class="container-fluid">
  ...
  <div class="alert alert-success" role="alert">
    ...
    <p>Selamat datang <strong><?= $username; ?></strong> di Sistem Informasi Akademik Prodi PTIK Universitas Bung 
    Hatta, anda login sebagai <strong><?= $level; ?></strong></p>
    <hr>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-3 text-info text-center">
              <a href="<?= base_url('administrator/mahasiswa'); ?>"><p class="nav-link small text-info">MAHASISWA</p></a>
