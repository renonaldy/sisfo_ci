<div class="container-fluid">
  <div class="alert alert-success" role="alert">
    <i class="fas fa-university"></i> Form Input Laporan KKN
  </div>

  <?= form_open_multipart('administrator/laporan_kkn/tambah_laporan_kkn_aksi'); ?>
