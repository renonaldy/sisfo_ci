...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav mx-auto">
      <a class="nav-link ml-3" href="landing_page">BERANDA <span class="sr-only">(current)</span></a>
      ...
      <a class="nav-link ml-3" href="administrator/auth">LOGIN</a>
    </div>
  </div>
</nav>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-justify">
        <?php foreach($tentang as $ttg): ?>
          ...
          <p><strong>Sejarah PTIK</strong>
          <?= $ttg->sejarah; ?></p>
          
          <p><strong>Visi PTIK</strong>
          <?= $ttg->visi; ?></p>

          <p><strong>Misi PTIK</strong>
          <?= $ttg->misi; ?></p>
        <?php endforeach; ?>
