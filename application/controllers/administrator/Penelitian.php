...
class Penelitian extends CI_Controller{
  ...
  public function index(){
    $data['penelitian'] = $this->penelitian_model->tampil_data('penelitian')->result();
    $this->load->view('templates_administrator/header');
    $this->load->view('templates_administrator/sidebar');
    $this->load->view('administrator/penelitian', $data);
  ...
  public function tambah_penelitian(){
    $this->load->view('templates_administrator/header');
    $this->load->view('templates_administrator/sidebar');
    $this->load->view('administrator/penelitian_form');
    $this->load->view('templates_administrator/footer');
  }

  public function tambah_penelitian_aksi(){
    $this->_rules();
    if($this->form_validation->run() == FALSE){
      $this->tambah_penelitian();
    }
    else{
      ...
      if($bukti=''){
        ...
        $config['upload_path']   = './assets/penelitian';
      ...
      $this->penelitian_model->insert_data($data, 'penelitian');
      $this->session->set_flashdata(
        'pesan',
        '<div class="alert alert-success alert-dismissible fade show" role="alert">
          Data Penelitian Dosen berhasil ditambahkan
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>'
      );
      redirect('administrator/penelitian');
    }
  }
